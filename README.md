...
![Visitors](https://komarev.com/ghpvc/?username=NyChieng&style=flat-square&color=C9956B&label=visitors)
...
```python
leslie = {
    "name"      : "Neng Yi (Leslie) Chieng",
    "location"  : "Sarawak, Malaysia 🇲🇾",
    "education" : "B.Sc Computer Science — AI Major @ Swinburne University (2023–2027)",
    "interests" : ["LLMs", "Computer Vision", "NLP", "OCR", "AI Automation"],
    "built"     : "OCR + Gemini API accounting automation for a local trading company",
    "also"      : "Insurance Agent @ Allianz — 5+ years of client-facing experience",
    "status"    : "🟡 Open to AI engineering internships & research collaborations",
}
```
...
<img src="https://skillicons.dev/icons?i=python,javascript,typescript,html,css,mysql&theme=dark&perline=6" />

**Frameworks & Tools**

<img src="https://skillicons.dev/icons?i=react,nextjs,git,vscode,vercel,github&theme=dark&perline=6" />
...
<img src="https://github-readme-streak-stats.herokuapp.com?user=NyChieng&hide_border=false&background=0D0B0A&stroke=2A2420&ring=C9956B&fire=C9956B&currStreakNum=EDE5DA&sideNums=EDE5DA&currStreakLabel=C9956B&sideLabels=C9956B&dates=9B8578&border=2A2420" />
